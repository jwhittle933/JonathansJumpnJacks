        ...
        <div className="macros-table" id="tracker">
            ...
            <table className="table-fill macros">
                ...
                <tbody>
                    <tr>
                        <td className="center">
                        { calulatedProteinCarbs } grams / day</td>
                        <td className="center">
                        { calulatedProteinCarbs } grams / day</td>
                        <td className="center">
                        { calulatedFat } grams / day</td>
                    </tr>
                    <tr>
                        <td className="center"> {
                            mealsSelection.selection ?
                            calulatedProteinCarbs / mealsSelection.selection
                            : 0
                            } grams / meal</td>
                        <td className="center"> {
                            mealsSelection.selection ?
                        ...
                        <td className="center"> {
                            mealsSelection.selection ?
                            calulatedFat / mealsSelection.selection
                            : 0
                            } grams / meal</td>
                    </tr>
                    <tr>
